...
% **************************************************
\newcommand{\thesisTitle}{Investigate an approach to distributed storage that ensures consistency semantics tailored to the application, while retaining scalability and availability.}

\newcommand{\thesisName}{Saalik Hatia}
\newcommand{\thesisSubject}{Distributed Systems}

\newcommand{\thesisDate}{mai 2023}
\newcommand{\thesisVersion}{Draft Version}
...
\usepackage{mathpartir} % Formatting inference rules
\usepackage{graphicx}  %% Graphics
\usepackage{mathtools} % Math tools
\usepackage{microtype} % Fine control of character spacing (load after babel, inputenc, and font-changing packages)
