...
\begin{titlepage}
	...
	\begin{flushleft}
		...
		\jurymember{Antoine}{Miné}{Professeur}{Sorbonne Université}{Role dans le jury}
		\jurymember{Gaël}{Thomas}{Professeur}{Sorbonne Université}{Rapporteur}
		...
		\jurymember{Marc}{Shapiro}{Directeur de Recherche}{Sorbonne Université, LIP6}{Directeur de thèse}
	\end{flushleft}
\end{titlepage}
\restoregeometry
